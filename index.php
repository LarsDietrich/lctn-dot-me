...
//				showRelatives();
			...
			function shortenUrl() {
				...
				longurl = root + "?lat=" + selectedLocation.lat() + "&lng=" + selectedLocation.lng() + "&heading=" + heading + "&pitch=" + pitch + "&zoom=" + zoom + "&container=" + active_container + "&maptype=" + maptype ;
				shorturl = "";
		...
		<div class="container">
			...
			<div id="view-container-left" class="span-12">
				<div id="map_container">
					<div class="header">
						<div onclick="toggleMapSize()" title="Shows a map of the immediate area around the location, use the controls on the map to manipulate it.">Map</div>
					</div>
