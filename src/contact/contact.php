...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			<form action="/" method="post" id="sendEmail">
				...
				<div>
					<input style="width:91.6%; font-size: large; background-color: transparent; color: #000; border-color: #000" type="text" name="emailFrom" id="emailFrom" value="<?= $_POST['emailFrom']; ?>" />
				</div>
