<div class="topmenu">	
	<ul class="topnav">
		...
		<li><a><label title="See a street view of the chosen location. Not available everywhere." id="streetview" class="config" onclick="setConfigOption(this);">Streetview</label></a></li>
		...
		<li><a><label title="See tweets by people that have enabled location based tweets. Can filter on range and text." id="twitter" class="config" onclick="setConfigOption(this);">Twitter</label></a></li>
		<li><a><label title="See still image and time capture webcams in the area. Can filter by range." id="webcam" class="config" onclick="setConfigOption(this);">Webcams</label></a></li>
 		<li><a><label title="See places of interest around the current location. Data supplied by Foursquare." id="places" class="config" onclick="setConfigOption(this);">Places</label></a></li>
		<li><a><label title="See pictures taken by people in the area. Can filter by range but is dependant on provider limitations. Data supplied by Panoramio, Flickr and Instagram" id="picture" class="config" onclick="setConfigOption(this);">Photos</label></a></li>
	    <li><img src="/images/topnav_bg_divider.png"/></li>
