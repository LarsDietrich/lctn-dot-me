<div class="topmenu">	
	<ul class="topnav">
		...
		<li><a><label title="See pictures taken by various people in the area. Can filter by range (sort of)." id="picture" class="config" onclick="setConfigOption(this);">Photos</label></a></li>
