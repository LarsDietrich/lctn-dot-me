<div onmouseover="$(this).css('z-index', '100')" onmouseout="$(this).css('z-index', '10')" id="picture_container" class="draggable panel">
	<span>
		<div class="header-left" title="Shows photos in the area.">
			Photos
		</div>
